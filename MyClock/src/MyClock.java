...
class clock extends JComponent{
    ...
    public clock(){
        ...
        add(display2);
        display2.setBounds(115, 350, 250, 20);
        display2.setFont(f);
        hour = now.getHours();
        min = now.getMinutes();
        sec = now.getSeconds();
    ...
    public void paintComponent(Graphics g1){
        ...
        for(int i = 0;i < 60;i++)
        {
            ...
            x = co[0];
            y = co[1];
            if(i == 0 || i == 5 || i == 10 || i == 15 || i == 20 || i == 25 || i == 30 || i == 35 || i == 40 || i == 45 || i == 50 || i == 55)//画12个大点
            {
        ...
        //画四个数字
        g.setFont(f2);
        g.drawString("III", 327, 171);
        g.drawString("VI", 192, 305);
        g.drawString("IX", 58, 171);
        g.drawString("XII", 191, 38);
